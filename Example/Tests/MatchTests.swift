...
class MatchTests: XCTestCase {
    ...
    private func setupExpectedMatches() -> [RootMatch] {
        let match1 = Match(id: 1, player1Id: 34, player2Id: 35, state: .complete, tournamentId: 12345, winnerId: 34, scoresCsv: "5-3", suggestedPlayOrder: 1, player1Votes: nil, player2Votes: nil)
        let match2 = Match(id: 2, player1Id: 86, player2Id: 43, state: .complete, tournamentId: 12345, winnerId: 43, scoresCsv: "1-5", suggestedPlayOrder: 3, player1Votes: nil, player2Votes: nil)
        let match3 = Match(id: 3, player1Id: 90, player2Id: 39, state: .complete, tournamentId: 12345, winnerId: 39, scoresCsv: "2-5", suggestedPlayOrder: 5, player1Votes: nil, player2Votes: nil)
        let match4 = Match(id: 4, player1Id: 33, player2Id: 36, state: .open, tournamentId: 12345, winnerId: nil, scoresCsv: "", suggestedPlayOrder: 6, player1Votes: nil, player2Votes: nil)
        let match5 = Match(id: 5, player1Id: 87, player2Id: 42, state: .open, tournamentId: 12345, winnerId: nil, scoresCsv: "", suggestedPlayOrder: 7, player1Votes: nil, player2Votes: nil)
